...
export default function NotificationDialog() {
  return (
    <div
      className="z-20 hidden max-w-sm my-4 absolute right-2 top-11 overflow-hidden text-base list-none bg-white divide-y divide-gray-100 rounded shadow-lg dark:divide-gray-600 dark:bg-gray-700"
